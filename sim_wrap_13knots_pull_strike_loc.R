...
sim_ship_strike_fun_13k_loc <- function(strike_dist){
           ...
           start_up_bay <- as.data.frame(one_track_df_up) %>%
            ...
            mat_X_up <- matrix(nrow = nobs_whale_up_13k, ncol = 20)
            mat_Y_up <- matrix(nrow = nobs_whale_up_13k, ncol = 20)
            ...
            loc_num_whale_u <- as.data.frame(rep(1:nobs_whale_up_13k, 20))
            ...
            mat_X_down <- matrix(nrow = nobs_whale_down_13k, ncol = 20)
            mat_Y_down <- matrix(nrow = nobs_whale_down_13k, ncol = 20)
            ...
            loc_num_whale_d <- as.data.frame(rep(1:nobs_whale_down_13k, 20))
