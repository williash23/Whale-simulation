...
for (i in 1:nrep){
    strike_loc <- sim_ship_strike_fun_13k_loc(strike_dist = 50)
...
strike_loc_list = list()
for (i in 1:nrep){
    strike_loc <- sim_ship_strike_fun_13k_loc(strike_dist = 25)
    strike_loc_list[[i]] <- strike_loc 
}
...
strike_loc_list = list()
for (i in 1:nrep){
    strike_loc <- sim_ship_strike_fun_13k_loc(strike_dist = 10)
    strike_loc_list[[i]] <- strike_loc 
}
...
strike_loc_list = list()
for (i in 1:nrep){
    strike_loc <- sim_ship_strike_fun_20k_loc(strike_dist = 50)
    strike_loc_list[[i]] <- strike_loc 
}
...
strike_loc_list = list()
for (i in 1:nrep){
    strike_loc <- sim_ship_strike_fun_20k_loc(strike_dist = 25)
    strike_loc_list[[i]] <- strike_loc 
}
...
strike_loc_list = list()
for (i in 1:nrep){
    strike_loc <- sim_ship_strike_fun_20k_loc(strike_dist = 10)
    strike_loc_list[[i]] <- strike_loc 
}
